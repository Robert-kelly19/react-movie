  ...
  return (
    <>
      <div
        className="head"
        style={{
          backgroundImage: `linear-gradient(to top,rgb(0, 0, 0),rgba(29, 27, 26, 0.61)),url(${background.url})`,
        }}
      >
        <div className="container">
          <div className="container1">
            ...
            <p className="dis">
              ...
              start to appear, forcing Peter to discover what it <br /> truly
